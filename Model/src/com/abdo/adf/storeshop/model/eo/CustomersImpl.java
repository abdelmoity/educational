...
public class CustomersImpl extends EntityImpl {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("com.abdo.adf.storeshop.model.eo.Customers");
    }
     ...
     */
    public RowIterator getBillSale() {
        return (RowIterator)getAttributeInternal(BILLSALE);
    }
     ...
     */
     ...
     private Number getNextId() throws SQLException {
        ...
        Number result=null ;
        try {
            String sql="SELECT nvl(max(C.ID),0)+1 from CUSTOMERS C ";
